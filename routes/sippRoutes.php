...
Route::group(['middleware' => ['portalAuth']], function() {
	...
	Route::group(['middleware' => ['portalAuth.view']], function() {
		...
		/* === Sipp Barang === */
		Route::group(['prefix' => 'sipp/barang'], function() {
			Route::get('/', 'sipp/barang@index');		
			Route::post('/search_dt', 'sipp/barang@search_dt');
			Route::post('/get_voucher', 'sipp/barang@get_voucher');			
		});

		/* === Sipp Gudang === */
		Route::group(['prefix' => 'sipp/gudang'], function() {
			Route::get('/', 'sipp/gudang@index');		
			Route::post('/search_dt', 'sipp/gudang@search_dt');
			Route::post('/get_voucher', 'sipp/gudang@get_voucher');
			Route::post('/search_data_voucher', 'sipp/gudang@search_data_voucher');		
			Route::post('/show_dtl', 'sipp/gudang@show_dtl');			
		});
